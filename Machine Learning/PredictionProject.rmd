...
```{r p1,,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE}
#Data Loading 
...
```{r p2,,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE}
...
```{r p3,,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE}
#data cleaning
library(caret)
...
```{r p5,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE}
library(caret)
set.seed(13333)
...
```{r p6,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE}
fitControl2<-trainControl(method="cv", number=5, allowParallel=T, verbose=T)
...
```{r p7,message=FALSE,warning=FALSE,cache=TRUE,echo=TRUE }
getwd()
